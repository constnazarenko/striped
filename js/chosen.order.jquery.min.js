jQuery(function($) {
    $('.chosenFORM').on('submit', function(){
        $(this).find('.chosen-select[multiple]').each(function(){
            var me = $(this), selectedoptions = $(this).getSelectionOrder();
            me.find('option').remove();
            $(selectedoptions).each(function(i,v){
                me.append($(document.createElement("option")).attr('value',v).prop('selected',true));
            });
        });
    });
});
